 ...
 */
static void buffer_verify(ssh_buffer_t * buf){
  int doabort=0;
  if(buf->data == NULL)
    return;
 ...
 */
ssh_buffer_t *ssh_buffer_new(void) {
  ssh_buffer_t *buf = malloc(sizeof(ssh_buffer_t));

  if (buf == NULL) {
    return NULL;
  }
  memset(buf, 0, sizeof(ssh_buffer_t));
  buffer_verify(buf);
  return buf;
}
 ...
 */
void ssh_buffer_free(ssh_buffer_t *buffer) {
  if (buffer == NULL) {
    return;
  }
...
static int realloc_buffer(ssh_buffer_t *buffer, size_t needed) {
  size_t smallest = 1;
  char *new;
 ...
 */
static void buffer_shift(ssh_buffer_t * buffer){
  buffer_verify(buffer);
  if(buffer->pos==0)
    return;
 ...
 */
int buffer_reinit(ssh_buffer_t *buffer) {
  buffer_verify(buffer);
 ...
 * @return              0 on success, < 0 on error.
 */
int buffer_add_data(ssh_buffer_t *buffer, const void *data, uint32_t len) {
  buffer_verify(buffer);
 ...
 * @return              0 on success, < 0 on error.
 */
int buffer_add_ssh_string(ssh_buffer_t *buffer,
    ssh_string_t *string) {
  uint32_t len = 0;
 ...
 */
int buffer_add_u32(ssh_buffer_t *buffer,uint32_t data){
 ...
 * @return              0 on success, -1 on error.
 */
int buffer_add_u16(ssh_buffer_t *buffer,uint16_t data){
  if (buffer_add_data(buffer, &data, sizeof(data)) < 0) {
    return -1;
  }
 ...
 * @return              0 on success, -1 on error.
 */
int buffer_add_u64(ssh_buffer_t *buffer, uint64_t data){
  if (buffer_add_data(buffer, &data, sizeof(data)) < 0) {
    return -1;
  }
 ...
 * @return              0 on success, -1 on error.
 */
int buffer_add_u8(ssh_buffer_t *buffer,uint8_t data){
 ...
 * @return              0 on success, -1 on error.
 */
int buffer_prepend_data(ssh_buffer_t *buffer, const void *data,
    uint32_t len) {
  buffer_verify(buffer);
 ...
 * @return              0 on success, -1 on error.
 */
int buffer_add_buffer(ssh_buffer_t *buffer,
    ssh_buffer_t *source) {
 ...
 * @see buffer_get_len()
 */
void *ssh_buffer_get_begin(ssh_buffer_t *buffer){
  return buffer->data;
}
 ...
 * @see buffer_get()
 */
void *buffer_get_rest(ssh_buffer_t *buffer){
 ...
 * @see buffer_get()
 */
uint32_t ssh_buffer_get_len(ssh_buffer_t *buffer){
    return buffer->used;
}
 ...
 * @see buffer_get_rest()
 */
uint32_t buffer_get_rest_len(ssh_buffer_t *buffer){
  buffer_verify(buffer);
 ...
 */
uint32_t buffer_pass_bytes(ssh_buffer_t *buffer, uint32_t len){
    buffer_verify(buffer);
 ...
 * @return              The new size of the buffer.
 */
uint32_t buffer_pass_bytes_end(ssh_buffer_t *buffer, uint32_t len){
  buffer_verify(buffer);
 ...
 */
uint32_t buffer_get_data(ssh_buffer_t *buffer, void *data, uint32_t len){
    /*
 ...
 */
int buffer_get_u8(ssh_buffer_t *buffer, uint8_t *data){
 ...
 * \returns 4 otherwise.
 */
int buffer_get_u32(ssh_buffer_t *buffer, uint32_t *data){
 ...
 */
int buffer_get_u64(ssh_buffer_t *buffer, uint64_t *data){
 ...
 */
ssh_string_t *buffer_get_ssh_string(ssh_buffer_t *buffer) {
  uint32_t stringlen;
  uint32_t hostlen;
 ...
 */
ssh_string_t *buffer_get_mpint(ssh_buffer_t *buffer) {
  uint16_t bits;
  uint32_t len;
  ssh_string_t *str = NULL;
