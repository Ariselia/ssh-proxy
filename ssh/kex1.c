...
static ssh_string_t * make_rsa1_string(ssh_string_t * e, ssh_string_t * n){
  ssh_buffer_t * buffer = NULL;
  ssh_string_t * rsa = NULL;
...
static int build_session_id1(ssh_session_t * session, ssh_string_t * servern,
    ssh_string_t * hostn) {
  MD5CTX md5 = NULL;
...
static ssh_string_t * ssh_encrypt_rsa1(ssh_session_t * session,
                                   ssh_string_t * data,
                                   ssh_public_key key) {
...
static ssh_string_t * encrypt_session_key(ssh_session_t * session, ssh_public_key srvkey,
    ssh_public_key hostkey, int slen, int hlen) {
  unsigned char buffer[32] = {0};
  int i;
  ssh_string_t * data1 = NULL;
  ssh_string_t * data2 = NULL;
...
SSH_PACKET_CALLBACK(ssh_packet_publickey1){
  ssh_string_t * server_exp = NULL;
  ssh_string_t * server_mod = NULL;
  ssh_string_t * host_exp = NULL;
  ssh_string_t * host_mod = NULL;
  ssh_string_t * serverkey = NULL;
  ssh_string_t * hostkey = NULL;
  ...
  (void)type;
  (void)user;
  SSH_INFO(SSH_LOG_PROTOCOL, "Got a SSH_SMSG_PUBLIC_KEY");
  ...
  if ((ko != sizeof(uint32_t)) || !host_mod || !host_exp
    ...
    SSH_INFO(SSH_LOG_RARE, "Invalid SSH_SMSG_PUBLIC_KEY packet");
  ...
  SSH_INFO(SSH_LOG_PROTOCOL, "Sending SSH_CMSG_SESSION_KEY");
   ...
   SSH_INFO(SSH_LOG_PROTOCOL, "%d bits, %" PRIdS " bytes encrypted session",
...
int ssh_get_kex1(ssh_session_t * session) {
  SSH_INFO(SSH_LOG_PROTOCOL, "Waiting for a SSH_SMSG_PUBLIC_KEY");
  ...
  SSH_INFO(SSH_LOG_PROTOCOL, "Waiting for a SSH_SMSG_SUCCESS");
  ...
  SSH_INFO(SSH_LOG_PROTOCOL, "received SSH_SMSG_SUCCESS\n");
