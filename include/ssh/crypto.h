...
#ifdef HAVE_ECDH
    EC_KEY *ecdh_privkey;
    ssh_string_t * ecdh_client_pubkey;
    ssh_string_t * ecdh_server_pubkey;
#endif
...
#endif
    ssh_string_t * dh_server_signature; /* information used by dh_handshake. */
