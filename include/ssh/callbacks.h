...
#ifndef SSH_CALLBACK_H
#define SSH_CALLBACK_H
...
typedef int (*ssh_message_callback) (ssh_session_t *, ssh_message_t * message, void *user);
typedef int (*ssh_channel_callback_int) (ssh_channel_t * channel, int code, void *user);
typedef int (*ssh_channel_callback_data) (ssh_channel_t * channel, int code, void *data, size_t len, void *user);
 ...
 */
typedef void (*ssh_log_callback) (ssh_session_t * session, int priority,
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
typedef void (*ssh_status_callback) (ssh_session_t * session, float status,
		void *userdata);
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
typedef void (*ssh_global_request_callback) (ssh_session_t * session,
                                        ssh_message_t * message, void *userdata);
 ...
 * @param session current session handler
 * @param userdata Userdata to be passed to the callback function.
 * @returns a valid ssh_channel_t * handle if the request is to be allowed
 * @returns NULL if the request should not be allowed
 * @warning The channel pointer returned by this callback must be closed by the application.
 */
typedef ssh_channel_t * (*ssh_channel_open_request_x11_callback) (ssh_session_t * session,
 ...
 */
typedef int (*ssh_auth_password_callback) (ssh_session_t * session, const char *user, const char *password,
		void *userdata);
 ...
 * @returns SSH_AUTH_DENIED Authentication failed.
 */
typedef int (*ssh_auth_none_callback) (ssh_session_t * session, const char *user, void *userdata);
 ...
 */
typedef int (*ssh_auth_gssapi_mic_callback) (ssh_session_t * session, const char *user, const char *principal,
		void *userdata);
 ...
 * @returns SSH_AUTH_DENIED Authentication failed.
 */
typedef int (*ssh_auth_pubkey_callback) (ssh_session_t * session, const char *user, ssh_key_t *pubkey,
...
typedef int (*ssh_service_request_callback) (ssh_session_t * session, const char *service, void *userdata);
 ...
 * @warning The channel pointer returned by this callback must be closed by the application.
 */
typedef ssh_channel_t * (*ssh_channel_open_request_session_callback) (ssh_session_t * session, void *userdata);
 ...
 * @returns an ssh_string_t * containing the chosen OID, that's supported by both
 * client and server.
 * @warning It is not necessary to fill this callback in if libssh is linked
 * with libgssapi.
 */
typedef ssh_string_t * (*ssh_gssapi_select_oid_callback) (ssh_session_t * session, const char *user,
		int n_oid, ssh_string_t * *oids, void *userdata);
 ...
 * with libgssapi.
 */
typedef int (*ssh_gssapi_accept_sec_ctx_callback) (ssh_session_t * session,
		ssh_string_t * input_token, ssh_string_t * *output_token, void *userdata);
 ...
 * with libgssapi.
 */
typedef int (*ssh_gssapi_verify_mic_callback) (ssh_session_t * session,
		ssh_string_t * mic, void *mic_buffer, size_t mic_buffer_size, void *userdata);
 ...
 */
SSH_API int ssh_set_server_callbacks(ssh_session_t * session, ssh_server_callbacks cb);
 ...
 */
typedef int (*ssh_packet_callback) (ssh_session_t * session, uint8_t type, ssh_buffer_t * packet, void *user);
...
#define SSH_PACKET_CALLBACK(name) \
	SSH_API int name (ssh_session_t * session, uint8_t type, ssh_buffer_t * packet, void *user)
 ...
 * @return SSH_OK on success, SSH_ERROR on error.
 */
SSH_API int ssh_set_callbacks(ssh_session_t * session, ssh_callbacks cb);
 ...
 * be sent in the next callback message, when more data is available.
 */
typedef int (*ssh_channel_data_callback) (ssh_session_t * session,
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
typedef void (*ssh_channel_eof_callback) (ssh_session_t * session,
                                           ssh_channel_t * channel,
                                           void *userdata);
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
typedef void (*ssh_channel_close_callback) (ssh_session_t * session,
                                            ssh_channel_t * channel,
                                            void *userdata);
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
typedef void (*ssh_channel_signal_callback) (ssh_session_t * session,
                                            ssh_channel_t * channel,
                                            const char *signal,
                                            void *userdata);
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
typedef void (*ssh_channel_exit_status_callback) (ssh_session_t * session,
                                            ssh_channel_t * channel,
                                            int exit_status,
                                            void *userdata);
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
typedef void (*ssh_channel_exit_signal_callback) (ssh_session_t * session,
                                            ssh_channel_t * channel,
                                            const char *signal,
                                            int core,
                                            const char *errmsg,
 ...
 */
typedef int (*ssh_channel_pty_request_callback) (ssh_session_t * session,
                                            ssh_channel_t * channel,
                                            const char *term,
 ...
 * @returns 1 if the request is denied
 */
typedef int (*ssh_channel_shell_request_callback) (ssh_session_t * session,
                                            ssh_channel_t * channel,
                                            void *userdata);
/**
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
typedef void (*ssh_channel_auth_agent_req_callback) (ssh_session_t * session,
                                            ssh_channel_t * channel,
                                            void *userdata);
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
typedef void (*ssh_channel_x11_req_callback) (ssh_session_t * session,
                                            ssh_channel_t * channel,
 ...
 * @returns -1 if the request is denied
 */
typedef int (*ssh_channel_pty_window_change_callback) (ssh_session_t * session,
                                            ssh_channel_t * channel,
                                            int width, int height,
                                            int pxwidth, int pwheight,
                                            void *userdata);
 ...
 * @returns 1 if the request is denied
 */
typedef int (*ssh_channel_exec_request_callback) (ssh_session_t * session,
                                            ssh_channel_t * channel,
                                            const char *command,
                                            void *userdata);
 ...
 */
typedef int (*ssh_channel_env_request_callback) (ssh_session_t * session,
                                            ssh_channel_t * channel,
                                            const char *env_name,
 ...
 * @returns 1 if the request is denied
 */
typedef int (*ssh_channel_subsystem_request_callback) (ssh_session_t * session,
                                            ssh_channel_t * channel,
 ...
 * @return SSH_OK on success, SSH_ERROR on error.
 */
SSH_API int ssh_set_channel_callbacks(ssh_channel_t * channel,
 ...
 */
SSH_API int ssh_threads_set_callbacks(struct ssh_threads_callbacks_struct
    *cb);
 ...
 */
SSH_API struct ssh_threads_callbacks_struct *ssh_threads_get_pthread(void);
 ...
 * @see ssh_threads_set_callbacks
 */
SSH_API struct ssh_threads_callbacks_struct *ssh_threads_get_noop(void);
 ...
 */
SSH_API int ssh_set_log_callback(ssh_logging_callback cb);
 ...
 */
SSH_API ssh_logging_callback ssh_get_log_callback(void);
